/**
 * Shared mono SVG glyphs. stroke="currentColor" ONLY — never hardcoded
 * colors (v1 hardcoded stroke="#000", invisible on dark — A10).
 */
...
function svgProps({ size = 16, strokeWidth = 2, className }: GlyphProps) {
  return {
    width: size,
    height: size,
    viewBox: '0 0 24 24',
...
export function MicGlyph(p: GlyphProps) {
  return (
    <svg {...svgProps(p)}>
...
export function EyeOffGlyph(p: GlyphProps) {
  return (
    <svg {...svgProps(p)}>
