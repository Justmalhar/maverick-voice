/** Per-step 30px (20px for the compact welcome cards) monochrome glyphs — every
 * onboarding step gets one so the IconBadge slot is never empty (steps.tsx). */
export const ICONS = {
  mic: (
  ...
  chain: (
    <svg width="20" height="20" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
